...
ENV_VARS = [
    ...
    ('TR_BATCH_ITEMS', '20',
     'Most short segments sent to the model in one request'),
    ('TR_BATCH_CHARS', '1500',
     'Most characters in one batched request'),
    ('TR_BATCH_ITEM_CHARS', '200',
     'Longest segment that is batched; a longer one goes on its own'),
